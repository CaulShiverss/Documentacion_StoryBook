...
/**
 * Detail component displays detailed information about a selected movie or actor.
 *
 * - If `idInterprete` is present in the route params, it shows the details of the selected actor from the movie.
 * - If `idInterprete` is not present, it shows the movie details and a list of its actors.
 *
 * @component
 * @returns {JSX.Element} The rendered detail view for a movie or actor.
 *
 * @example
 * // Route: /detalle/pelicula/1
 * <Detail />
 *
 * // Route: /detalle/pelicula/1/interprete/0
 * <Detail />
 */
function Detail() {
