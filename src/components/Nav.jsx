...
/**
 * Responsive navigation component with accessible hamburger menu.
 *
 * - Displays navigation links for "Inicio", "Películas", "Intérpretes", and "Admin".
 * - On mobile, shows a hamburger button to toggle the menu visibility.
 * - Uses transition effects for menu open/close animations.
 * - Closes the menu when a navigation link is clicked.
 * - Applies active and hover styles to navigation links.
 *
 * @component
