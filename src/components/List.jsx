 ...
 * @param {React.ReactNode} props.children - Biography or description text to display
 * 
 * @returns {React.ReactElement} An article element containing the interpreter's information with image, name, and biography
 * 
 * @example
 * <List 
 ...
 *   esNota10={true}
 * >
 *   Award-winning actor with 20 years of experience
 * </List>
 */
function List(props) {
